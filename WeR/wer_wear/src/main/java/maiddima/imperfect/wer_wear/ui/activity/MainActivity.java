...
import maiddima.imperfect.wer_wear.Constants;
import maiddima.imperfect.wer_wear.R;
import maiddima.imperfect.wer_wear.RequestQueueSingleton;
import maiddima.imperfect.wer_wear.ShakeEventListener;
import maiddima.imperfect.wer_wear.model.Message;
import maiddima.imperfect.wer_wear.model.MessageAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list_messages.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent messageDetail = new Intent(getApplicationContext(), MessageDetail.class);
                messageDetail.putExtra("maiddima.imperfect.wer_wear.STUDENT_ID",msg.getStudent_id());
                messageDetail.putExtra("maiddima.imperfect.wer_wear.MESSAGE",msg.getStudent_message());
                messageDetail.putExtra("maiddima.imperfect.wer_wear.GPS_LAT",msg.getGps_lat());
                messageDetail.putExtra("maiddima.imperfect.wer_wear.GPS_TOP",msg.getGps_long());
